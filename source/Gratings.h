...
double ( * gp1(double zloc,double r0,double el0, double w0, double Grat3x[], double Grat3I[]));//prototype
...
double ( * gp2(double zloc, double el1x, double w1x, double r1x, double Grat3x[], double Grat3I[]));//prototype
